...
public class BlockModelLeavesSeasonalFlowering<T extends BlockLogic> extends BlockModelLeaves<T> {
    private final IconCoordinate grownAppleOverlay;
    private final IconCoordinate floweringAppleOverlay;

    public BlockModelLeavesSeasonalFlowering(Block<T> block, String baseTexturePath, String overlayName) {
    ...
    public boolean render(Tessellator tessellator, int x, int y, int z) {
        ...
        int growthRate = BlockLogicLeavesSeasonalFlowering.getGrowthRate(renderBlocks.blockAccess.getBlockMetadata(x, y, z));
