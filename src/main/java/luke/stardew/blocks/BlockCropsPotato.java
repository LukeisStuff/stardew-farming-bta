...
@Deprecated
public class BlockCropsPotato extends BlockLogicFlower implements IBonemealable {
	public BlockCropsPotato(Block<?> block) {
		super(block);
	...
	public boolean onBlockRightClicked(World world, int x, int y, int z, Player player, Side side, double xHit, double yHit) {
		...
		if (l == 2) {
			...
			world.dropItem(x, y, z, new ItemStack(StardewItems.potato));
			world.dropItem(x, y, z, new ItemStack(StardewItems.seedsPotato, world.rand.nextInt(1) + 2));
			player.swingItem();
		}
		return false;
	}
