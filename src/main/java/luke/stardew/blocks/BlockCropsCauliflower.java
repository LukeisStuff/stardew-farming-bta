...
public class BlockCropsCauliflower extends BlockFlower implements IBonemealable {
	public static final int[] GROWTH_STAGE_TEXTURES_TOP = new int[]{
		TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "cauliflower_crop_4.png"),
		TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "cauliflower_crop_3.png"),
		TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "cauliflower_crop_2.png"),
		TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "cauliflower_crop_1.png")
	};
	public static final int[] GROWTH_STAGE_TEXTURES_SIDE = new int[]{
		TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "cauliflower_crop_side_4.png"),
		TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "cauliflower_crop_side_3.png"),
		TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "cauliflower_crop_side_2.png"),
		TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "cauliflower_crop_side_1.png")
	};
	public static final int LEAF_TEXTURE = TextureHelper.getOrCreateBlockTextureIndex(MOD_ID, "cauliflower_crop_leaf.png");

	public BlockCropsCauliflower(String key, int id) {
		super(key, id);
	}
