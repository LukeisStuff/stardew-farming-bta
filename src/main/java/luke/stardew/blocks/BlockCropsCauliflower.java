...
@Deprecated
public class BlockCropsCauliflower extends BlockLogicFlower implements IBonemealable {

	public BlockCropsCauliflower(Block<?> block) {
		super(block);
	}
	...
	public void getCollidingBoundingBoxes(World world, int x, int y, int z, AABB aabb, ArrayList<AABB> aabbList) {
		...
		int meta = world.getBlockMetadata(x, y, z);
		if (meta != 0) {
			AABB.getTemporaryBB((double)x + aabb.minX, (double)y + aabb.minY, (double)z + aabb.minZ, (double)x + aabb.maxX, (double)y + aabb.maxY, (double)z + aabb.maxZ);
		}
	}
