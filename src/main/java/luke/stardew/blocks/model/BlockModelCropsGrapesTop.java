...
public class BlockModelCropsGrapesTop<T extends Block> extends BlockModelStandard<T> {
	public final IconCoordinate[] growthStageTextures = new IconCoordinate[]{
		TextureRegistry.getTexture("stardew:block/grapes_crop_top_1"),
		TextureRegistry.getTexture("stardew:block/grapes_crop_top_2"),
		TextureRegistry.getTexture("stardew:block/grapes_crop_top_3")
	};

	public BlockModelCropsGrapesTop(Block block) {
		super(block);
	}
