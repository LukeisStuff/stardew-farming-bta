...
public class BlockModelCropsGrapesTop<T extends BlockLogic> extends BlockModelStandard<T> {
	public final IconCoordinate[] growthStageTextures = new IconCoordinate[]{
		TextureRegistry.getTexture(MOD_ID + ":block/grape_crop_top_1"),
		TextureRegistry.getTexture(MOD_ID + ":block/grape_crop_top_2"),
		TextureRegistry.getTexture(MOD_ID + ":block/grape_crop_top_3")
	};

	public BlockModelCropsGrapesTop(Block<T> block) {
		super(block);
	}
