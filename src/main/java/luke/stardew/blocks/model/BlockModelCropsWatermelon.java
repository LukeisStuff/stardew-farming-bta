...
public class BlockModelCropsWatermelon<T extends Block> extends BlockModelStandard<T> {
	public static final IconCoordinate[] GROWTH_STAGE_TEXTURES_TOP = new IconCoordinate[]{
		TextureRegistry.getTexture("stardew:block/watermelon_crop_1"),
		TextureRegistry.getTexture("stardew:block/watermelon_crop_2"),
		TextureRegistry.getTexture("stardew:block/watermelon_crop_3"),
		TextureRegistry.getTexture("stardew:block/watermelon_crop_4")
	};

	public static final IconCoordinate[] GROWTH_STAGE_TEXTURES_SIDE = new IconCoordinate[]{
		TextureRegistry.getTexture("stardew:block/watermelon_crop_side_1"),
		TextureRegistry.getTexture("stardew:block/watermelon_crop_side_2"),
		TextureRegistry.getTexture("stardew:block/watermelon_crop_side_3"),
