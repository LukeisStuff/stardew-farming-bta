...
public class BlockModelCropsBeansBottom<T extends Block> extends BlockModelStandard<T> {
	public final IconCoordinate[] growthStageTextures = new IconCoordinate[]{
		TextureRegistry.getTexture("stardew:block/beans_crop_bottom_1"),
		TextureRegistry.getTexture("stardew:block/beans_crop_bottom_2"),
		TextureRegistry.getTexture("stardew:block/beans_crop_bottom_3"),
		TextureRegistry.getTexture("stardew:block/beans_crop_bottom_4"),
		TextureRegistry.getTexture("stardew:block/beans_crop_bottom_5"),
		TextureRegistry.getTexture("stardew:block/beans_crop_bottom_6"),
		TextureRegistry.getTexture("stardew:block/beans_crop_bottom_7")
	};

	public BlockModelCropsBeansBottom(Block block) {
		super(block);
	}
	...
	public IconCoordinate getBlockTextureFromSideAndMetadata(Side side, int data) {
		return this.growthStageTextures[MathHelper.clamp(data, 0, 6)];
	}
}
