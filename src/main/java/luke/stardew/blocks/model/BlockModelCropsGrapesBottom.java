...
public class BlockModelCropsGrapesBottom<T extends Block> extends BlockModelStandard<T> {
	public final IconCoordinate[] growthStageTextures = new IconCoordinate[]{
		TextureRegistry.getTexture("stardew:block/grape_crop_bottom_1"),
		TextureRegistry.getTexture("stardew:block/grape_crop_bottom_2"),
		TextureRegistry.getTexture("stardew:block/grape_crop_bottom_3"),
		TextureRegistry.getTexture("stardew:block/grape_crop_bottom_4"),
		TextureRegistry.getTexture("stardew:block/grape_crop_bottom_5")
	};
