...
public class BlockModelCropsBlueberry<T extends Block> extends BlockModelStandard<T> {
	public final IconCoordinate[] growthStageTextures = new IconCoordinate[]{
		TextureRegistry.getTexture("stardew:block/blueberry_crop_1"),
		TextureRegistry.getTexture("stardew:block/blueberry_crop_2"),
		TextureRegistry.getTexture("stardew:block/blueberry_crop_3"),
		TextureRegistry.getTexture("stardew:block/blueberry_crop_4"),
		TextureRegistry.getTexture("stardew:block/blueberry_crop_5")
	};

	public BlockModelCropsBlueberry(Block block) {
		super(block);
	}
