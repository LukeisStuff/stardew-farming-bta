...
public class BlockModelCropsBlueberry<T extends BlockLogic> extends BlockModelStandard<T> {
	public final IconCoordinate[] growthStageTextures = new IconCoordinate[]{
		TextureRegistry.getTexture(MOD_ID + ":block/blueberry_crop_1"),
		TextureRegistry.getTexture(MOD_ID + ":block/blueberry_crop_2"),
		TextureRegistry.getTexture(MOD_ID + ":block/blueberry_crop_3"),
		TextureRegistry.getTexture(MOD_ID + ":block/blueberry_crop_4"),
		TextureRegistry.getTexture(MOD_ID + ":block/blueberry_crop_5")
	};

	public BlockModelCropsBlueberry(Block<T> block) {
		super(block);
	}
