...
public class BlockModelBush<T extends Block> extends BlockModelStandard<T> {
	public final IconCoordinate[] growthStageTextures = new IconCoordinate[]{
		TextureRegistry.getTexture("stardew:block/bushSpring"),
		TextureRegistry.getTexture("stardew:block/bushSummer"),
		TextureRegistry.getTexture("stardew:block/bushFall"),
		TextureRegistry.getTexture("stardew:block/bushWinter"),
		TextureRegistry.getTexture("stardew:block/bushDead")
	};
