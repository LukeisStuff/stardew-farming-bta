...
public class BlockPlantStake extends BlockLogic {
	public BlockPlantStake(Block<?> block, Material material) {
	...
	public boolean canBlockStay(World world, int x, int y, int z) {
		return world.getBlockId(x, y - 1, z) == Blocks.FARMLAND_DIRT.id();
	}

	/* FIXME don't know which function this is
