...
public class BlockCropsStrawberry extends BlockFlower implements IBonemealable {
	...
	public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int x, int y, int z, int meta, TileEntity tileEntity) {
		return meta != 4 ? new ItemStack[]{new ItemStack(StardewItems.seedsStrawberry)} : new ItemStack[]{new ItemStack(StardewItems.seedsStrawberry, world.rand.nextInt(1) + 1), new ItemStack(StardewItems.strawberry, world.rand.nextInt(3) + 1)};
	}
