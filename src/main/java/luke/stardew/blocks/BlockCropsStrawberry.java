...
@Deprecated
public class BlockCropsStrawberry extends BlockLogicFlower implements IBonemealable {
	public BlockCropsStrawberry(Block<?> block) {
		super(block);
	...
	public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int x, int y, int z, int meta, TileEntity tileEntity) {
		if (meta == 3) {
			return new ItemStack[]{new ItemStack(StardewItems.strawberry, world.rand.nextInt(1) + 1), new ItemStack(StardewItems.seedsStrawberry, world.rand.nextInt(1) + 2)};
		}
