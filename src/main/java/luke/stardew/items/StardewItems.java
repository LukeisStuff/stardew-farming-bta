...
public class StardewItems {
    ...
    public static void initializeItems() {
        ...
        TOOL_FISHINGROD_STONE = new ItemBuilder(MOD_ID)
            .build(new ItemToolFishingRodTiered(MOD_ID + ".tool.fishingrod.stone", itemNSID("tool_fishingrod_stone"), itemID("TOOL_FISHINGROD_STONE"), ToolMaterial.stone));
        TOOL_FISHINGROD_IRON = new ItemBuilder(MOD_ID)
            .build(new ItemToolFishingRodTiered(MOD_ID + ".tool.fishingrod.iron", itemNSID("tool_fishingrod_iron"), itemID("TOOL_FISHINGROD_IRON"), ToolMaterial.iron));
        TOOL_FISHINGROD_GOLD = new ItemBuilder(MOD_ID)
            .build(new ItemToolFishingRodTiered(MOD_ID + ".tool.fishingrod.gold", itemNSID("tool_fishingrod_gold"), itemID("TOOL_FISHINGROD_GOLD"), ToolMaterial.gold));
        TOOL_FISHINGROD_DIAMOND = new ItemBuilder(MOD_ID)
            .build(new ItemToolFishingRodTiered(MOD_ID + ".tool.fishingrod.diamond", itemNSID("tool_fishingrod_diamond"), itemID("TOOL_FISHINGROD_DIAMOND"), ToolMaterial.diamond));
        TOOL_FISHINGROD_STEEL = new ItemBuilder(MOD_ID)
            .build(new ItemToolFishingRodTiered(MOD_ID + ".tool.fishingrod.steel", itemNSID("tool_fishingrod_steel"), itemID("TOOL_FISHINGROD_STEEL"), ToolMaterial.steel));

        WORM = new ItemBuilder(MOD_ID)
            .build(new Item(MOD_ID + ".worm", itemNSID("worm"), itemID("WORM")));
