...
public class NetEntryTomato implements IVehicleEntry<ProjectileTomato>, ITrackedEntry<ProjectileTomato> {
    public @NotNull Class<ProjectileTomato> getAppliedClass() {
        return ProjectileTomato.class;
    }
    ...
    public Entity getEntity(World world, double x, double y, double z, int metadata, boolean hasVelocity, double xd, double yd, double zd, Entity owner, @Nullable CompoundTag tag) {
        return new ProjectileTomato(world, x, y, z);
    }

    public PacketAddEntity getSpawnPacket(EntityTrackerEntry tracker, ProjectileTomato trackedObject) {
